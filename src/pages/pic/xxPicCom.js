...
import {
  ...
  getHead,
  getHeiSi,
  getMeinvpic, getPCMeinvpic,
  getRandom4kPic,
  getRandomAcgPic,
  getWallpaper, getWapmeinvpic
} from "../../services/xxAPI/img";
...
function getImgUrl(props) {
  const { api, url, setUrl, setLoading, step, setStep } = props;
  setLoading(true)
  let urlStr = "error";
  api()
    .then((res) => {
...
// 名称对应的api地址
const apiMap = {
  "随机二次元图片": getRandomAcgPic,
  "随机黑丝图片": getHeiSi,
  "随机白丝图片": getBaiSi,
  "随机美女图片": getMeinvpic,
  "随机头像": getHead,
  "随机4K图片": getRandom4kPic,
  "随机壁纸图片": getWallpaper,
  "bing每日一图": getBingImg,
  "手机端美女图片接口": getWapmeinvpic,
  "电脑端美女图片": getPCMeinvpic,
}
